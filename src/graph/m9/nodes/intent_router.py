"""
Intent Router — same as M8 (keyword-based routing).

M9 doesn't change the intent router — the innovation is in
how subgraph nodes call tools, not how routing works.
"""
