"""
State definitions -- M11: PlanOrchestrator Integration.

Adds orchestrator-related fields to ParentState:
  - plan_graph: the PlanGraph DAG managed by the orchestrator
  - orchestrator_events: list of events emitted during orchestration
"""
