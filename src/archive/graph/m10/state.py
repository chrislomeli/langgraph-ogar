"""
State definitions — M10: InstrumentedGraph + StateMediator.

Same state as M9 — no state changes in this milestone.
The innovation is in HOW the graph is built (InstrumentedGraph)
and HOW results flow to state (StateMediator), not what fields exist.
"""
