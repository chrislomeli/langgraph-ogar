...
Supports registration, lookup, listing, and MCP-shaped export
...
class ToolRegistry:
    ...
    def catalog(self) -> list[dict[str, Any]]:
        """
        Return MCP-style tool catalog.

        Shape matches MCP Tool objects closely:
          - name
          - description
          - inputSchema
            ...
            tools.append(
                {
                    ...
                    # optional MCP fields you may add later:
                    # "title": None,
                    # "annotations": None,
                    # "_meta": {},
                }
